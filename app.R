        ...
        grid_container(
          ...
          grid_card(
            ...
            card_body(
              ...
              **View Standard Model:** The standard model will be displayed in the middle of the page.
              ...
              **Create Your Own Model:** The selection pane below contains every variable that is
              ...
              are those belonging to the standard model.
              ...
              **Compare Models:** The most recent model you created will be
              displayed next to the standard model so you can compare your new model with
              ...
              ***Note:*** *To produce the standard model, the app creates a large
